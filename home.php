...
header.masthead {
    ...
    background: url('https://images5.alphacoders.com/335/335086.jpg') no-repeat center center;
...
.mybg-events {
    background: url('http://yesofcorsa.com/wp-content/uploads/2017/11/Flower-Tea-Best-Wallpaper-1024x686.jpg') no-repeat center center fixed;
    background-size: cover;
}
   ...
   <nav class="navbar fixed-top navbar-expand-lg navbar-dark">
        <div class="container">
            <a class="navbar-brand" href="index.html">
                <h3 class="my-heading ">TEA-CHA <span class="bg-main"></span></h3>
            </a>
          ...
          <ul class="mob-ul">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-link">
                        <a class="btn btn-primary btn-block btn-login" href="index.php">Login</a>
                    </li>
                    <li class="nav-link">
                        <a class="btn btn-primary btn-block btn-register" href="register.php">Register</a>
                    </li>
        ...
        <div class="container slider-top-text">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h3 class="my-heading">TEA-CHA<span class="bg-main"></span></h3>
                    <p class="myp-slider text-center">Where there is tea there is hope</p>
                    <p class="myp text-center">SHARE YOUR MEMORIES   |   CONNECT WITH OTHERS   |   MAKE NEW FRIENDS</p>
                    <a class="btn btn-primary btn-join" href="#">Its not a tea,It's a refreshing burst </a>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 wow fadeInUp">
                    <h3 class="title-heading text-center">EVENTS EVE</h3>
                        ...
                        <div class="my-grid">
                            <div class="row">
                                <div class="col-sm-6 col-md-4 mb-3">
                                    ...
                                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRd4IODFkec0FQ7je5GRDANU-bcmdyGTLVXQ2TBCrV4L1Afzu6tsQ" class="img-fluid">
                                    
                                </div>
                                <div class="col-sm-6 col-md-8 mb-3 ">
                                    
                                    <img src=https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRyKmm5ZKWoeIJ7A91uRBeNjBfLHJ-Jt5b2hBkszsu4Fehku66yAA"" class="img-fluid">
                                
                                </div>

                                <div class="col-md-8 mb-3">
                                    <div class="text-block">
                                        <h5 class="events-heading"></h5>
                                        <p class="myp-font"></p>
                                    </div>
                                </div>
                                <div class=" col-md-4 ">
                                     
                                    <img src="https://images.unsplash.com/photo-1536998003793-b13c28fae74b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&w=1000&q=80" class="img-fluid">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 mx-auto wow fadeInUp">
                    <h3 class="text-center font-weight-bold">JOIN FOR A TEA BREAK <span class="bg-main">TEA-CHA :)</span></h3>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mt-4 wow bounceInUp" data-wow-duration="1.4s">
                    <div class="card">
                        <img class="card-img-top" src="https://mail.google.com/mail/u/0?ui=2&ik=23198a87ab&attid=0.1&permmsgid=msg-f:1645891900099662346&th=16d761f67c22120a&view=att&disp=safe">
                        <div class="card-block">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mt-4 wow bounceInUp" data-wow-duration="1.4s">
                    <div class="card">
                        <img class="card-img-top" src="https://stmed.net/sites/default/files/styles/1920x1200/public/tea-wallpapers-28313-6086981.jpg?itok=0sSsvsnh">
                        <div class="card-block">

                            <h4 class="card-title text-center">TEA-CHA</h4>
    ...
    <section class="testimonials text-center mybg-music">
        <div class="container">
            <div class="row">
                <div class="col-md-12 wow fadeInUp">
                    <h3 class="title-heading text-center font-weight-bold"></h3>
                    <p class="myp text-center"></p>
                </div>
            </div>
